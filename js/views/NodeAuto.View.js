define(["jquery", "underscore", "backbone", "text!app/templates/Node.Template.html", "text!app/templates/NodeAuto.Template.html", "app/views/NodeModal.View"], function($, _, Backbone, NodeTemplate, NodeDroppedTemplate, NodeModalView)
{
	var NodeView = Backbone.View.extend({
		...
		{
			/*
			 When an element is dropped from the left
			 */
			if (this.droppable) {
				this.tag = this.app.dragTarget.view;
				// tagView
				...
				this.model.set("xpaths", [this.tag.xpaths]);
				// this.xpaths;
				this.createModal();
				this.modal.open();
				this.showDropped();
